...
import NButton from "./EncryptButton";
...
const BubbleText = () => {
    ...
    spans.forEach((span) => {
      ...
      span.addEventListener("mouseleave", function (this: typeof span) {
        ...
        if (rightNeighbor) {
          ...
          rightNeighbor.style.color = "rgb(126, 79, 255)";
        }
      });
    });
  }, []);
  ...
  return (
    <div>
      <h2 className="hover-text text-center text-5xl font-thin text-indigo-700">
        <Text>Let's do it together</Text>
      </h2>
    </div>
  );
};
